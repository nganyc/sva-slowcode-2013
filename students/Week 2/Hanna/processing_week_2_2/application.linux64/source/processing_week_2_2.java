...
public class processing_week_2_2 extends PApplet {
...
line(pmouseX, pmouseY, mouseX, mouseY);}
  ...
  strokeWeight(0.5f);
  stroke(255, 50); // any function? 0<x<?
 ...
 if(mousePressed == true){
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "processing_week_2_2" };
    if (passedArgs != null) {
